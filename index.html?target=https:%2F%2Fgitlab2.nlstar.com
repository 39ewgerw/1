...
<div id='panel'>
       ...
       <div style='float:right; position:relative; top:-1em; font-weight:bold;'>
		...
		<button id='archiveBtn' onclick='if (confirm("Are you sure?")) submit({}, "/?target=https://gitlab2.nlstar.com&mode=archive&recursive")'>Archive</button>
		<a href="/?target=https://gitlab2.nlstar.com&tpl=list&folders-filter=\&recursive">Get list</a>
		</center>
	</fieldset>
		...
		<br />Server time: 11/20/2021 6:06:54 AM
		<br />Server uptime: 01:23:30
	</fieldset>
